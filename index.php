...
<div class="slider">
    <div id="heroSlider" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="4000">
        ...
        <!-- Controls -->
        <button class="carousel-control-prev d-md-block d-none" type="button" data-bs-target="#heroSlider" data-bs-slide="prev">
            <span class="carousel-control-prev-icon"></span>
        </button>

        <button class="carousel-control-next d-md-block d-none" type="button" data-bs-target="#heroSlider" data-bs-slide="next">
...
<div class="text-center py-4 headline_mobile">
    ...
    <h1 class="headline">Makeup & Hair <br> By Nikkis</h1>
    ...
    <div class="container">
        ...
        <div class="mission-content">
            ...
            <div class="w-md-100 w-75 mx-auto">
                <p class="para ">
                    “What you created is beyond anything I ever could have dreamed up on my own. It feels like you reached into my brain and heart and translated everything I care about into something visually stunning and deeply intentional.
                ...
                <img src="https://img.freepik.com/premium-vector/signature_951413-443.jpg?semt=ais_hybrid&w=740&q=80" width="130" class="m-auto">
            </div>
...
<section class="parallax-gallery">
    <div class="container">
        <div class="service_headline">
            <h2> ...and takes you beyond what <br> you ever dreamed possible.</h2>
...
<section class="insta-gallery-section section-gap">
    <div class="container">
        <h3 class="headline text-center mb-3">Follow Us</h3>
    </div>
    ...
    <div class="container">
        ...
        <div class="gallery-header text-center">
            ...
            <h2 class="headline w-50 m-auto">
                Professional care for your <br> perfect day
            </h2>
        ...
        <div class="photo_gallery owl-carousel d-none mt-3">
            ...
            <div class="gallery-item">
                <a href="assets/img/home/gallery/01- (3).jpeg" data-fancybox="gallery">
                    <img src="assets/img/home/gallery/01- (3).jpeg" alt="">
                </a>
            </div>
            ...
            <div class="gallery-item">
                <a href="assets/img/home/gallery/01- (6).jpeg" data-fancybox="gallery">
                    <img src="assets/img/home/gallery/01- (6).jpeg" alt="">
                </a>
            </div>
        ...
        <div class="testimonial-wrapper">
            ...
            <div class="testimonial-right owl-carousel">
                ...
                <div class="testimonial-item">
                    ...
                    <p class="para">
                        Jasmine is incredibly talented and creates the perfect look for you,
                        adapting styles to your face and brief. Jasmine did my and my bridesmaids
                        make up for my wedding flawlessly; her skills are amazing! Jasmine’s
                        lovely calm, friendly and humorous personality was a great addition
                        to my wedding morning. I couldn’t recommend Jasmine enough!
                    </p>
                ...
                <div class="testimonial-item">
                    ...
                    <p class="para">
                        Absolutely loved the bridal makeup! Everything stayed perfect all day.
                        Highly professional service and very friendly experience.
                    </p>
